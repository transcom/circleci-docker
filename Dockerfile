...
FROM circleci/python:3.9.2-buster-node
...
ARG CIRCLECI_CLI_VERSION=0.1.14915
ARG CIRCLECI_CLI_SHA256SUM=ebdf42047a32b3f44280205c99936dc9880cc08f7a5d5db94b0a0eb5f67dd437
RUN set -ex && cd ~ \
